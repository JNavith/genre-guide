...
<Binary
  ...
  <div
    ...
    theme-light:text-green-500 theme-light:hover:text-green-600
    theme-dark:text-green-400 theme-dark:hover:text-green-300"
  ...
  {#if state}
    <ul
      ...
      theme-dark:bg-gray-800 theme-dark:text-gray-400 font-body font-light
