...
<nav style="background-color: #23A566">
	<AccentBar />
	...
	<div class="flex justify-between items-center py-3 sm:py-4 md:py-6">
		...
		<div class="mr-2">
			<a
				...
				font-heading font-medium text-white"
				href="/"
		...
		<div class="ml-2 flex items-center">
			{#each Object.entries(routes) as [smallTitle, { route, description }]}
				<a
					class="block mr-3 sm:mr-4 md:mr-6 text-md sm:text-lg
					md:text-xl font-heading text-white"
					href={route}
					title={description}
					rel="prefetch">
					{smallTitle}
