...
def test_parse_alternative_names_single_simple() -> None:
...
def test_parse_alternative_names_double_simple() -> None:
...
def test_parse_alternative_names_single_shortened() -> None:
...
def test_parse_alternative_names_single_imperfect() -> None:
...
def test_parse_alternative_names_short_for() -> None:
...
def test_parse_alternative_names_combo_simple() -> None:
...
def test_parse_alternative_names_combo_complex() -> None:
