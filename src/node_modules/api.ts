...
export const call = async ({
	fetch, query, timeout = 1000, variables,
	...
	const timeoutPromise = new Promise<Await<typeof responsePromise>>((_resolve, reject) => setTimeout(() => reject(new Error(`timed out after ${timeout} ms`)), timeout));
