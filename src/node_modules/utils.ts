...
export const serializeError = (error: Error): SerializableError => ({name: error.name, message: error.message, ...Object.fromEntries(Object.getOwnPropertyNames(error).map((prop) => [prop, (error as any)[prop]])) });
